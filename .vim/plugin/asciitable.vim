...
" Modified By:	Eric Wald <eswald at brainshell dot org>
" Version:	1.1.1
" License:      Vim License
" =============================================================================
...
" v1.1.1 09-May-2006 Changed commands for convenience

"*****************************************************************
"* Asciitable commands
"*****************************************************************
:command! -nargs=? Asciitable call Asciitable(<f-args>)
:command! -nargs=0 AsciitableO call Asciitable(8)
:command! -nargs=0 AsciitableH call Asciitable(16)
